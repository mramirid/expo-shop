...
export const signUp = createAsyncThunk<FireAuthResBody, AuthInputPayload, AppThunkAPIConfig>(
  'auth/signUp',
...
export const signIn = createAsyncThunk<FireAuthResBody, AuthInputPayload, AppThunkAPIConfig>(
  'auth/signIn',
  async (payload, thunkAPI) => {
    try {
